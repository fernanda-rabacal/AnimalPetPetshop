    ...
    <AboutContainer className="container">
      <AboutContent>
        <div>
          ...
          <HistoryText size="l">
            Nossa história começa em 2015, com apenas uma sala pequena e um espaço de tosa. Apesar das dificuldades iniciais, aos poucos nossa loja foi tomando forma, contratamos mais e mais funcionários, ampliamos o espaço, construímos o consultório veterinário e reformamos o espaço de tosa. Hoje contamos com 3 veterinários, 3 profissionais de banho e tosa, alem de um espaço quase 3 vezes maior do que o inicial. Aumentamos também a variedade de produtos vendidos, desde acessórios, produtos higiênicos, medicamentos, rações, petiscos, camas e muito mais. Mas não paramos por aqui, estamos sempre trabalhando para trazer o maior conforto para nossos clientes e pretendemos aumentar mais ainda nossa marca!
          </HistoryText>
        </div>
